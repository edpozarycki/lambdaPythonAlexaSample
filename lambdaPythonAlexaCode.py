...
def update_fact_database(intent, session):
    ...
    # If fact is populated, and we have the family member in the session attribute, read back 
    # the fact and ask for confirmation before writing it to the database.
    #
